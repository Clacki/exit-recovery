...
export const mockUsers: User[] = [
  {
    ...
    interests: ["생산성", "운영", "웰니스"],
    keywords: ["회복 설계", "인터뷰", "프로토타입"],
  },
  {
    id: "user-002",
    name: "김준",
    ...
    interests: ["매칭", "커뮤니티", "대시보드"],
    keywords: ["프론트엔드", "접근성", "컴포넌트"],
  },
  {
    id: "user-003",
    name: "이세라",
  ...
  },
  {
    ...
    interests: ["운영", "인수인계", "아카이브"],
    keywords: ["백엔드", "데이터 모델", "API"],
  },
];
